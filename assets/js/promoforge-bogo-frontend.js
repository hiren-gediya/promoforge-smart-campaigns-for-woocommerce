jQuery(document).ready(function ($) {
    ...
    $(document).on('click', '.bogo-popup-btn', function (e) {
        ...
        try {
            if (typeof promoforge_bogo_ajax === 'undefined') {
                console.error('promoforge_bogo_ajax is undefined. Script localization failed.');
                return;
            }
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'promoforge_load_bogo_product_form',
                    ...
                    discount: discount,
                    nonce: promoforge_bogo_ajax.nonce || ''
                },
                dataType: 'json',
    ...
    $(document).on('submit', '#bogo-offer-modal form', function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'promoforge_bogo_add_to_cart',
                product_id: productId,
